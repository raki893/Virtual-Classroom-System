...
class TablesController extends Controller 
{
   	...
   	public function index()
	{
		...
		return view('vcr.tables.index',$this->data);
	}   
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'vcr/tables/tables/'.$table : 'vcr/tables/tableinfo/'.$table ) ;
        return view('vcr.tables.config',$this->data);
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return Redirect::to('vcr/tables')->with('messagetext', 'Table(s) has been deleted')->with('msgstatus','success');  
        } 
        return Redirect::to('vcr/tables')->with('messagetext','error','No Table(s) deleted !')->with('msgstatus','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('vcr.tables.field',$this->data);
    }
