 {!! Form::open(array('url'=>'vcr/module/dobuild/'.$module_name, 'class'=>'form-horizontal','id'=>'rebuildForm')) !!}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <a href="{{ url('vcr/module/rebuild/'.$module_id)}}" class="btn btn-danger" id="rebuild" ><i class="icon-spinner7"></i> Rebuild All Codes </a> 
      </div>
  </div> 
<hr />
    <p class="text-center " style="font-weight: bold;">
