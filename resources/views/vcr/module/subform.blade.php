...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }}  <small> :  Extend form ( Setting Child Form ) </small> </h4></div>
    ...
    @include('vcr.module.tab',array('active'=>'subform'))

      <ul class="nav nav-tabs" style="margin-bottom:10px;">
          <li  ><a href="{{ URL::to('vcr/module/form/'.$module_name)}}">Form Configuration </a></li>
          <li class="active" ><a href="{{ URL::to('vcr/module/subform/'.$module_name)}}">Sub Form </a></li> 
        <li ><a href="{{ URL::to('vcr/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
      </ul>
    ...
    {!! Form::open(array('url'=>'vcr/module/savesubform/'.$module_name, 'class'=>'form-horizontal  ')) !!}
        ...
        <div class="col-md-8">
          ...
          <a href="{{ url('vcr/module/subformremove/'.$module_name) }}" class="btn btn-danger"><i class="icon-cancel-circle2 "></i> Remove </a>
          @endif
         </div> 
        </div> 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ url('vcr/module/combotable') }}",
    {selected_value : "{{ (isset($subform['table']) ? $subform['table']: null ) }}" }); 
    $("#key").jCombo("{{ url('vcr/module/combotablefield') }}?table=",
