...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }} <small> Master Detail :  Manage View Lookup </small></h4></div>
    ...
    @include('vcr.module.tab',array('active'=>'sub','type'=> $type))
    ...
    {!! Form::open(array('url'=>'vcr/module/savesub/'.$module_name, 'class'=>'form-horizontal  ')) !!}
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="vcrConfirmDelete('{{ URL::to('vcr/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
