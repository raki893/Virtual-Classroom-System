...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("{{ URL::to('vcr/module/combotable') }}" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("{{ URL::to('vcr/module/combotablefield') }}?table=",
	...
	<?php $lv = explode("|", $f['option']['lookup_value']); ?>
		...
		$("#lookup_value1").jCombo("{{ URL::to('vcr/module/combotablefield') }}?table=",
		{ selected_value : "<?php echo (isset($lv[0]) ? $lv[0] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value2").jCombo("{{ URL::to('vcr/module/combotablefield') }}?table=",
		{ selected_value : "<?php echo (isset($lv[1]) ? $lv[1] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value3").jCombo("{{ URL::to('vcr/module/combotablefield') }}?table=",
 ...
 {!! Form::open(array('url'=>'vcr/module/saveformfield/'.$module_name, 'class'=>'form-horizontal')) !!}
...
<fieldset>
	<legend> <a href="#" onclick="$( '.addhtml' ).toggle()"> <small> More  </small> </a></legend>
