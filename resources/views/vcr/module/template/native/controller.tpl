...
class {controller}Controller extends Controller {
	...
	public function getShow( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			return redirect('{class}')->with('messagetext','Record Not Found !')->with('msgstatus','error');					
		}
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			return redirect('{class}/update/'.$request->input('{key}'))->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return redirect('{class}?return='.self::returnUrl())
