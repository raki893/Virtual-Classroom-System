...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			...
			@endif 
			<a href="{{ URL::to( 'core/forms/search?return='.$return) }}" class="btn btn-xs btn-default" onclick="vcrModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>				
	...
	<div class="box-body"> 	
	 ...
	 {!! Form::open(array('url'=>'core/forms/delete?return='.$return, 'class'=>'form-horizontal' ,'id' =>'vcrTable' )) !!}
