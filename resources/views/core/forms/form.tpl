...
<link href="{{ asset('vcr/js/plugins/iCheck/skins/square/red.css')}}" rel="stylesheet">
<script type="text/javascript" src="{{ asset('vcr/js/plugins/iCheck/icheck.min.js') }}"></script>
